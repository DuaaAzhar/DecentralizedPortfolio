  ...
  const defaultProjects = [
    {
      ...
      description: "RoyalMintBox is a secure ERC-721 NFT minting contract with tiered access — gold members get 75% discount and 5 mints in the first 24 hours, followed by white members with 2 mints, using ReentrancyGuard and Ownable for security.",
      image: "mintBox.png",
      githubLink: "RoyalMintBox",
    ...
    {
      id: 2,
      name: "Digital Bond Platform",
      description: "Concept of digitalizing the prize bonds and getting rewards on them. NFTs sold as a smart bond against PKR. The project basically deals with tokens and NFTs to realize the concept.",
      image: "prizeBond.jpg", 
      githubLink: "DigitalBond",
      liveLink: "https://example.com",
